namespace AutoDrivingCarSimulation.Shared
{
    public static class Constants
    {
        ...
        public const string ENTER_FIELD_DIMENSION = "Enter field dimentions (Width Height):";
        ...
        public const string FIELD_DIMENSION_ERROR = "Field dimensions must be positive.";
